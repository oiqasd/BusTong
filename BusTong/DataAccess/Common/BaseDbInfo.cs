...
namespace DataAccess.Common
{
    public class BaseDbInfo
    {
        ...
        {
            db.AddInParameter(Procdbcomm, name.Trim(), dbType, value);
        }
        /// <summary>
        /// 添加非string型的输出参数
        /// </summary>
        ...
        {
            db.AddOutParameter(Procdbcomm, name.Trim(), dbType, size);
        }
        /// <summary>
        ...
        /// <param name="name"></param>
        /// <param name="size"></param>
        public void AddInOutParameter(string name, int size)
        {
